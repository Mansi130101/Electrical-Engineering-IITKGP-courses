...
sig=zeros(L,1);
for i=1:L
    sig(i)=A*sin(2*pi*f1*i/fs)+B*x(i);
end
...
%subplot(2,2,3)
%plot(y)
%title('Low Pass Filtered Signal, M=32, dev=1');
%subplot(2,2,4)
plot(y_fixed)
title('Fixed point Low Pass Filtered Signal, M=32, dev=1, 1800');
...
%subplot(2,2,3)
%plot(y)
%title('Low Pass Filtered Signal,M=5, dev=1');
%subplot(2,2,4)
plot(y_fixed)
title('Fixed point Low Pass Filtered Signal,M=32, dev=1, 50');
...
%subplot(2,2,3)
%plot(y)
%title('Low Pass Filtered Signal,M=32, dev=10');
%subplot(2,2,4)
plot(y_fixed)
title('Fixed point Low Pass Filtered Signal,M=32, dev=10, 50');
...
%subplot(2,2,3)
%plot(y)
%title('Low Pass Filtered Signal,M=5, dev=10');
%subplot(2,2,4)
plot(y_fixed)
title('Fixed point Low Pass Filtered Signal,M=5, dev=10, 50');
